...
debug_resource::debug_resource(std::string name, std::pmr::memory_resource * up = std::pmr::get_default_resource()) : 
...
void debug_resource::do_deallocate(void *ptr, std::size_t bytes, std::size_t alignment) 
{
...
{
    return this == &other; 
    // You can simply return true in this case since the debug object has no state 
