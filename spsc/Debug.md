...
Building the project in debug mode turns and turning on the UBSCAN and TSCAN will add debug symbols in the project and notify the developer of trivial mistakes. 
